...
/**
 * The page for searching eBay
 * localhost:8080/UI/shopping
 */
...
public class ShoppingServlet extends HttpServlet {
	...
	public void printMainTitle(){
		...
		out.println("\n<!-- Mainbar Title -->\n<div class='page-head'>" +
				"<h2 class='pull-left'>Shopping Search" +
				"<span class='page-meta'>Powered by Amazon </span>" +
				"</h2>" + 
				"<div class='bread-crumb pull-right'>" +
				"<a href='index'> <i class='icon-home'></i> Home </a>" +
				"<span class='divider'>/</span>" +
				"<a href='shopping' class='bread-current'>Shopping</a>" + 
				"</div>" +
	...
	public void printOurResultsWidget(HttpServletRequest request, String query, String videoId){
		...
		// one normal entries
		printAmazonSliders(request, query);


		// main player
		printReviews(videoId);
	...
	public void printSidebarWidget(){
		...
		out.println("\n<!-- Sidebar -->\n" +
				...
				"<li class='nred'><a href='video'><i class='icon-facetime-video'></i>Video</a></li>" + 
				"<li class='ngreen current open'><a href='shopping'><i class='icon-shopping-cart'></i>Shopping</a></li>" +
	...
	public void printAmazonSliders(HttpServletRequest request, String query){
	...
	public void printExtraResultsWidget(String query){
		...
		if(azResults != null){
			...
			// main results: head
			out.println("<div class='widget-head'>" +              
					"<div class='pull-left'>Amazon Recommendation</div>" +
					"<div class='widget-icons pull-right'>" +   
					"<a href='#' class='wminimize'><i class='icon-chevron-up'></i></a>" +
					"<a href='#' class='wclose'><i class='icon-remove'></i></a>" +
					"</div>" +
			...
			for(int y = 6; y < 11; y ++){
				AmazonResult rs = azResults.get(y);
				// one item
				...
				out.println("<li>" +
						...
						"<a href='shopping?q=" + query + "'>" + rs.getTitle() + "</a>" +
						"<br>by + <strong>" + rs.getDesc() + " - " + rs.getImageURL() + " views </strong><p>" + rs.getDesc() + "</p>" +
						"</div> <div class='clearfix'></div>" +
						"</div>" +    // end user
						"</li>"); 
			}
		...
		//		// main results: head
		//		out.println("<div class='widget-head'>" +              
		//				"<div class='pull-left'>Amazon Results</div>" +
		//				"<div class='widget-icons pull-right'>" +   
		//				"<a href='#' class='wminimize'><i class='icon-chevron-up'></i></a>" +
		//				"<a href='#' class='wclose'><i class='icon-remove'></i></a>" +
		//				"</div>" +
		...
		//				"<ul class='latest-news'>");
		//		
		//		printRecommendedYouTubes();
		//				
		//		out.println("</ul>" +
		//				"</div></div>");  
		//		
		//		// END Amazon widget
		//		out.println("</div><!-- END Span4 Amazon -->");
	...
	public void printReviews(String id){
