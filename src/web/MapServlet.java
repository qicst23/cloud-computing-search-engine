...
/**
 * The page for searching map
 * localhost:8080/UI/map
 */
...
public class MapServlet extends HttpServlet {
	...
	public void printSidebarWidget(){
		...
		out.println("\n<!-- Sidebar -->\n" +
				...
				"<li class='norange current open'><a href='map'><i class='icon-map-marker'></i>Map</a></li>" +
				"</ul>" +
				"</div></div>");  // end sidebar
	}
