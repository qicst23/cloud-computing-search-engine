...
/**
 * The page for searching image
 * localhost:8080/UI/image
 */
...
public class ImageServlet extends HttpServlet {
	...
	public void printTopNavigationWidget(){
		...
		out.println("\n<!-- Navbar -->\n" +
				...
				// our brand name
				"<a href='index' class='brand'><span class='bold'>Banoogle</span></a>" + 
	...
	public void printSidebarWidget(){
		...
		out.println("\n<!-- Sidebar -->\n" +
				...
				"<li class='nviolet current open'><a href='image'><i class='icon-picture'></i>Images</a></li>" + 
